...
public class DialogMoVang : MonoBehaviour
{
    public static DialogMoVang instance;
    public Sprite spriteMoVang;
    ...
    public void Xay()
    {
        ...
        {
            objNhaMay.GetComponent<SpriteRenderer>().sprite = spriteMoVang;
    ...
    {
        InventoryManager.gold += thuHoach;
        thuHoach = 0;
